...
void encoder_init()
{
    encoder = new RotaryEncoder(ENCODER_PIN_B, ENCODER_PIN_A, RotaryEncoder::LatchMode::FOUR3);
    attachInterrupt(digitalPinToInterrupt(ENCODER_PIN_B), encoder_tick, CHANGE);
    attachInterrupt(digitalPinToInterrupt(ENCODER_PIN_A), encoder_tick, CHANGE);
