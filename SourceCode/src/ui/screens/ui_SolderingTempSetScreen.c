...
lv_obj_t * ui_SolderingTempSetScreen = NULL;
lv_obj_t * ui_SolderingKeyboard = NULL;
lv_obj_t * ui_SolderingConfirm = NULL;
lv_obj_t * ui_SolderingDelete = NULL;
lv_obj_t * ui_SolderingNum0 = NULL;
lv_obj_t * ui_SolderingNumPanel = NULL;
lv_obj_t * ui_SolderingNum1 = NULL;
lv_obj_t * ui_SolderingNum2 = NULL;
lv_obj_t * ui_SolderingNum3 = NULL;
lv_obj_t * ui_SolderingNum4 = NULL;
lv_obj_t * ui_SolderingNum5 = NULL;
lv_obj_t * ui_SolderingNum6 = NULL;
lv_obj_t * ui_SolderingNum7 = NULL;
lv_obj_t * ui_SolderingNum8 = NULL;
lv_obj_t * ui_SolderingNum9 = NULL;
lv_obj_t * ui_SolderingTempSetDock = NULL;
lv_obj_t * ui_TextSolderingTempSetting = NULL;
lv_obj_t * ui_SolderingTempSetting = NULL;
lv_obj_t * ui_SolderingSetTemp = NULL;
lv_obj_t * ui_TextSolderingCurrentTemp = NULL;
lv_obj_t * ui_SolderingCurrentTemp = NULL;
lv_obj_t * ui_SolderingTempSetBack = NULL;
// event funtions
...
void ui_SolderingTempSetScreen_screen_init(void)
{
    ...
    ui_object_set_themeable_style_property(ui_SolderingKeyboard, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_Container);
    ui_object_set_themeable_style_property(ui_SolderingKeyboard, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
    ...
    ui_object_set_themeable_style_property(ui_SolderingConfirm, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_ButtonPressed);
    ui_object_set_themeable_style_property(ui_SolderingConfirm, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum0, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_ButtonAndBack);
    ui_object_set_themeable_style_property(ui_SolderingNum0, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum0, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_ButtonPressed);
    ui_object_set_themeable_style_property(ui_SolderingNum0, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR_OPA,
                                           _ui_theme_alpha_ButtonPressed);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum1, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_ButtonAndBack);
    ui_object_set_themeable_style_property(ui_SolderingNum1, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_ButtonAndBack);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum1, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_ButtonPressed);
    ui_object_set_themeable_style_property(ui_SolderingNum1, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR_OPA,
                                           _ui_theme_alpha_ButtonPressed);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum2, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_ButtonAndBack);
    ui_object_set_themeable_style_property(ui_SolderingNum2, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_ButtonAndBack);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum2, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_ButtonPressed);
    ui_object_set_themeable_style_property(ui_SolderingNum2, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR_OPA,
                                           _ui_theme_alpha_ButtonPressed);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum3, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_ButtonAndBack);
    ui_object_set_themeable_style_property(ui_SolderingNum3, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_ButtonAndBack);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum3, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_ButtonPressed);
    ui_object_set_themeable_style_property(ui_SolderingNum3, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR_OPA,
                                           _ui_theme_alpha_ButtonPressed);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum4, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_ButtonAndBack);
    ui_object_set_themeable_style_property(ui_SolderingNum4, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_ButtonAndBack);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum4, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_ButtonPressed);
    ui_object_set_themeable_style_property(ui_SolderingNum4, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR_OPA,
                                           _ui_theme_alpha_ButtonPressed);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum5, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_ButtonAndBack);
    ui_object_set_themeable_style_property(ui_SolderingNum5, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_ButtonAndBack);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum5, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_ButtonPressed);
    ui_object_set_themeable_style_property(ui_SolderingNum5, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR_OPA,
                                           _ui_theme_alpha_ButtonPressed);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum6, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_ButtonAndBack);
    ui_object_set_themeable_style_property(ui_SolderingNum6, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_ButtonAndBack);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum6, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_ButtonPressed);
    ui_object_set_themeable_style_property(ui_SolderingNum6, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR_OPA,
                                           _ui_theme_alpha_ButtonPressed);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum7, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_ButtonAndBack);
    ui_object_set_themeable_style_property(ui_SolderingNum7, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_ButtonAndBack);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum7, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_ButtonPressed);
    ui_object_set_themeable_style_property(ui_SolderingNum7, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR_OPA,
                                           _ui_theme_alpha_ButtonPressed);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum8, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_ButtonAndBack);
    ui_object_set_themeable_style_property(ui_SolderingNum8, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_ButtonAndBack);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum8, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_ButtonPressed);
    ui_object_set_themeable_style_property(ui_SolderingNum8, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR_OPA,
                                           _ui_theme_alpha_ButtonPressed);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum9, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_COLOR,
                                           _ui_theme_color_ButtonAndBack);
    ui_object_set_themeable_style_property(ui_SolderingNum9, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_BG_OPA,
                                           _ui_theme_alpha_ButtonAndBack);
    ...
    ui_object_set_themeable_style_property(ui_SolderingNum9, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR,
                                           _ui_theme_color_ButtonPressed);
    ui_object_set_themeable_style_property(ui_SolderingNum9, LV_PART_MAIN | LV_STATE_PRESSED, LV_STYLE_BG_IMG_RECOLOR_OPA,
                                           _ui_theme_alpha_ButtonPressed);
    ...
    ui_object_set_themeable_style_property(ui_TextSolderingTempSetting, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_TEXT_COLOR, _ui_theme_color_TextAndImage);
    ui_object_set_themeable_style_property(ui_TextSolderingTempSetting, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA,
    ...
    ui_object_set_themeable_style_property(ui_SolderingSetTemp, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_COLOR,
                                           _ui_theme_color_TextAndImage);
    ui_object_set_themeable_style_property(ui_SolderingSetTemp, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA,
                                           _ui_theme_alpha_TextAndImage);
    ...
    ui_object_set_themeable_style_property(ui_TextSolderingCurrentTemp, LV_PART_MAIN | LV_STATE_DEFAULT,
                                           LV_STYLE_TEXT_COLOR, _ui_theme_color_TextAndImage);
    ui_object_set_themeable_style_property(ui_TextSolderingCurrentTemp, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA,
                                           _ui_theme_alpha_TextAndImage);
    ...
    ui_object_set_themeable_style_property(ui_SolderingCurrentTemp, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_COLOR,
                                           _ui_theme_color_TextAndImage);
    ui_object_set_themeable_style_property(ui_SolderingCurrentTemp, LV_PART_MAIN | LV_STATE_DEFAULT, LV_STYLE_TEXT_OPA,
                                           _ui_theme_alpha_TextAndImage);
...
void ui_SolderingTempSetScreen_screen_destroy(void)
{
    if(ui_SolderingTempSetScreen) lv_obj_del(ui_SolderingTempSetScreen);

    // NULL screen variables
    ui_SolderingTempSetScreen = NULL;
    ui_SolderingKeyboard = NULL;
    ui_SolderingConfirm = NULL;
    ui_SolderingDelete = NULL;
    ui_SolderingNum0 = NULL;
    ui_SolderingNumPanel = NULL;
    ui_SolderingNum1 = NULL;
    ui_SolderingNum2 = NULL;
    ui_SolderingNum3 = NULL;
    ui_SolderingNum4 = NULL;
    ui_SolderingNum5 = NULL;
    ui_SolderingNum6 = NULL;
    ui_SolderingNum7 = NULL;
    ui_SolderingNum8 = NULL;
    ui_SolderingNum9 = NULL;
    ui_SolderingTempSetDock = NULL;
    ui_TextSolderingTempSetting = NULL;
    ui_SolderingTempSetting = NULL;
    ui_SolderingSetTemp = NULL;
    ui_TextSolderingCurrentTemp = NULL;
    ui_SolderingCurrentTemp = NULL;
    ui_SolderingTempSetBack = NULL;
